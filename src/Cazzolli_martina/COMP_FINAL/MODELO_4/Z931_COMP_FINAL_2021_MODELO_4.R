...
PARAM  <- list()
PARAM$experimento <- "COMP_FINAL_TS9310_MODELO_4"

PARAM$exp_input  <- "COMP_FINAL_FE9250_MODELO_4"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c(202101,202102,202103, 202104,202105,202106,202107)

PARAM$train$training     <- c( 202101,202102,202103, 202104,202105,202106,202107)
PARAM$train$validation   <- c( 201919 )
