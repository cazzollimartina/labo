...
PARAM  <- list()
PARAM$experimento <- "COMP_FINAL_TS9310_v2"

PARAM$exp_input  <- "COMP_FINAL_FE9250"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c(202101,202102,202103, 202104,202107,201901,201902,201903,201904,201906,201907,201908,201909,201910,201911,201912,202010,202011,202012,202009)

PARAM$train$training     <- c( 202101,202102,202103, 202104,202107,201901,201902,201903,201904,201906,201907,201908,201909,201910,201911,201912,202010,202011,202012,202009)
