...
PARAM  <- list()
PARAM$experimento <- "COMP_FINAL_TS9310_MODELO_3"

PARAM$exp_input  <- "COMP_FINAL_FE9250_MODELO_3"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c(202101,202102,202103, 202104,201901,201902,201903,201904,201906,201905,201907,201908,201910,201911,201912)

PARAM$train$training     <- c( 202101,202102,202103, 202104,202107,201901,201902,201903,201904,201906,201907,201908,201910,201911,201912,)
PARAM$train$validation   <- c( 202105 )
PARAM$train$testing      <- c( 202106,202107,201909,202019 )
