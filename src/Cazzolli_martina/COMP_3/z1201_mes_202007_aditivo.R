...
dataset  <- dataset[  foto_mes==202007 ]
gc()
...
dtrain <- xgb.DMatrix( data=  as.matrix(dataset[ foto_mes==202007 , col_buenas, with=FALSE]),
                       label= dataset[ foto_mes==202007, clase01 ],
                       weight=  dataset[ foto_mes==202007,  ifelse( clase_ternaria=="BAJA+2", 1.000001, 1.0 ) ]
)
