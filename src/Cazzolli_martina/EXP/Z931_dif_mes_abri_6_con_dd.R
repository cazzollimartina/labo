...
PARAM  <- list()
PARAM$experimento <- "TS9310_mes_abr_dif_mes"

PARAM$exp_input  <- "FE9250"

PARAM$future       <- c( 202104)

PARAM$final_train  <- c(202008, 202009, 202010, 202012, 202101, 202011,202102,202103)

PARAM$train$training     <- c( 202008, 202009, 202010, 202011,202012,202101 )
