...
PARAM$input$training      <- c( 202101,202012,202011,202010,202009,202008 )
...
PARAM$hyperparametertuning$semilla_azar  <- 150151  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
